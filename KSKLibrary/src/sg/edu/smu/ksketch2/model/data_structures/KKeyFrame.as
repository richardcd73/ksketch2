...
package sg.edu.smu.ksketch2.model.data_structures
{
	...
	/**
	 * The KKeyFrame object serves as the abstract class that defines the core
	 * implementations of key frames in K-Sketch as a linked list. Do not
	 * instantiate this class by itself.
	 */
			...
			if(_previous)
			{
				...
				if(newTime <= _previous.time)
				{
					...
					if(!hasActivityAtTime())
					{
						...
						// nullify this key frame's current and previous key frame
						_previous = null;
						_next = null;
					}
