...
package sg.edu.smu.ksketch2.model.data_structures
{
	...
	/**
	 * The KModelObjectList object serves as the concrete class for a model object
	 * list sorted by their owner IDs in K-Sketch.
	 */
	public class KModelObjectList implements IModelObjectList
	{
		...
		/**
		 * The default constructor for initializing hte model object list.
		 */
		...
		/**
		 * Removes all objects not present in the other IModelObjectList from this list,
		 * given another IModelObjectList. This function modifies this model object list.
		 * 
