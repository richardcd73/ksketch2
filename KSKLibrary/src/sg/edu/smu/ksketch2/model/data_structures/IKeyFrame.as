...
package sg.edu.smu.ksketch2.model.data_structures
{
	...
	/**
	 * The IKeyFrame object serves as the interface for a key frame in K-Sketch.
	 */
	public interface IKeyFrame
	{
		...
		/**
		 * Splits this key into two parts -- a front key frame and a back key frame -- and returns the front key frame.
		 * 
